...
Route::namespace('Api')->group(function() {
    ...
    Route::post('property/{property}/update-status', 'PropertyController@updateStatus');

    Route::post('property/upload', 'PropertyUploadController@store');
    Route::post('property/upload/save-image', 'PropertyUploadController@saveImage');
    Route::post('property/upload/save-image-order', 'PropertyUploadController@saveImageOrder');
    Route::get('property/upload/get-images', 'PropertyUploadController@getImages');
    Route::post('property/upload/{model}/{id}/delete-image', 'PropertyUploadController@deleteImage');

    Route::get('blocks', 'BlockController@index');
    Route::post('block/create', 'BlockController@store');
    Route::get('block/{id}', 'BlockController@show');
    Route::get('block/{block}/edit', 'BlockController@edit');
    Route::post('block/{block}/update', 'BlockController@update');
    ...
    Route::post('content/{content}/update', 'ContentController@update');

    /* End::Properties route */

    /* Start::Locations route */
    Route::get('locations', 'LocationController@index');
    Route::get('location-list', 'LocationListController@index');
    /* End::Locations route */
    ...
    Route::group(['prefix' => 'enquiries'], function () {
        ...
        Route::get('/list',                'EnquiryController@list');
        Route::post('/create',             'EnquiryController@store');
        Route::get('/{enquiry}/edit',      'EnquiryController@edit');
        Route::post('/{enquiry}/update',   'EnquiryController@update');
        Route::get('/{enquiry}/delete',    'EnquiryController@destroy');
    });
...
//Route::get('/articles', 'PublicationsController@index');

Route::get('/articless', function () {
    $rowsNumber = 10;
    $data = [];
    for ($rowIndex = 0; $rowIndex < $rowsNumber; $rowIndex++) {
        $row = [
